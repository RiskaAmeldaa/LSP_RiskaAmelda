...
--
-- Host: localhost:3306
-- Generation Time: Aug 14, 2023 at 10:03 AM
...
--
-- Table structure for table `dbsuratmasuk_riska`
--

CREATE TABLE `dbsuratmasuk_riska` (
  ...
  `unit_penerbit` enum('Institusi','Jurusan Teknik Sipil','Jurusan Teknik Mesin','Jurusan Teknik Elektro','Jurusan Akuntansi','Jurusan Administrasi Bisnis') NOT NULL,
  `tempat` varchar(50) NOT NULL,
  `pengesah` enum('Direktur','Ketua Jurusan Teknik Sipil','Ketua Jurusan Teknik Mesin','Ketua Jurusan Teknik Elektro','Ketua Jurusan Akuntansi','Ketua Jurusan Administrasi Bisnis') NOT NULL,
  `tembusan` varchar(50) NOT NULL,
  `file_scan` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `dbsuratmasuk_riska`
--

INSERT INTO `dbsuratmasuk_riska` (`id_surat`, `no_surat`, `nama_pengirim`, `waktu`, `lampiran`, `perihal`, `nama_penerima`, `isi_surat`, `unit_penerbit`, `tempat`, `pengesah`, `tembusan`, `file_scan`) VALUES
(9, 'PT.PAMA EDIT', 'PT.PAMA EDIT', '0000-00-00', 'PT.PAMA EDIT', 'PT.PAMA EDIT', '', '', 'Institusi', 'PT.PAMA EDIT', 'Direktur', '', ''),
(12, 'aska4', 'aska4', '0000-00-00', 'aska4', 'aska4', '', '', 'Institusi', 'aska4', 'Direktur', '', '');
...
--
-- Indexes for table `dbsuratmasuk_riska`
--
ALTER TABLE `dbsuratmasuk_riska`
...
--
-- AUTO_INCREMENT for table `dbsuratmasuk_riska`
--
ALTER TABLE `dbsuratmasuk_riska`
  MODIFY `id_surat` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
